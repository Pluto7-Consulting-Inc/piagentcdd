...
class InlineContext(proto.Message):
    ...
    Attributes:
        ...
        datasource_references (google.cloud.dataqna_v1alpha1.types.DatasourceReferences):
            ...
            the question
        options (google.cloud.dataqna_v1alpha1.types.ConversationOptions):
...
class ConversationOptions(proto.Message):
    ...
    Attributes:
        chart (google.cloud.dataqna_v1alpha1.types.ChartOptions):
            Optional. Options for chart generation.
        analysis (google.cloud.dataqna_v1alpha1.types.AnalysisOptions):
...
class ChartOptions(proto.Message):
    ...
    Attributes:
        image (google.cloud.dataqna_v1alpha1.types.ChartOptions.ImageOptions):
    ...
    class ImageOptions(proto.Message):
        ...
        Attributes:
            no_image (google.cloud.dataqna_v1alpha1.types.ChartOptions.ImageOptions.NoImage):
                No image.

                This field is a member of `oneof`_ ``kind``.
            svg (google.cloud.dataqna_v1alpha1.types.ChartOptions.ImageOptions.SvgOptions):
                SVG format.
...
class AnalysisOptions(proto.Message):
    ...
    Attributes:
        python (google.cloud.dataqna_v1alpha1.types.AnalysisOptions.Python):
