...
from .transports.grpc import DataQuestionServiceGrpcTransport
from .transports.grpc_asyncio import DataQuestionServiceGrpcAsyncIOTransport
from .transports.rest import DataQuestionServiceRestTransport


class DataQuestionServiceClientMeta(type):
    """Metaclass for the DataQuestionService client.
    ...
    def get_transport_class(cls,
        ...
        ) -> Type[DataQuestionServiceTransport]:
...
class DataQuestionServiceClient(metaclass=DataQuestionServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DataQuestionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> DataQuestionServiceTransport:
        ...
        Returns:
            DataQuestionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DataQuestionServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DataQuestionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DataQuestionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DataQuestionServiceTransport, Callable[..., DataQuestionServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the data question service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DataQuestionServiceClient._read_environment_variables()
        self._client_cert_source = DataQuestionServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DataQuestionServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DataQuestionServiceTransport)
        if transport_provided:
            # transport is a DataQuestionServiceTransport instance.
            ...
            self._transport = cast(DataQuestionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            DataQuestionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DataQuestionServiceTransport], Callable[..., DataQuestionServiceTransport]] = (
                DataQuestionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., DataQuestionServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dataqna_v1alpha1.DataQuestionServiceClient`.",
                    extra = {
    ...
    def ask_question(self,
            ...
            *,
            ...
            ) -> Iterable[data_question_service.Message]:
        ...
        Args:
            request (Union[google.cloud.dataqna_v1alpha1.types.AskQuestionRequest, dict]):
        ...
        Returns:
            Iterable[google.cloud.dataqna_v1alpha1.types.Message]:
        ...
        rpc = self._transport._wrapped_methods[self._transport.ask_question]
    ...
    def __enter__(self) -> "DataQuestionServiceClient":
        return self
